require './lib.rb'
func1 = MasslynxFunction.new('/mnt/g/Dropbox/LAb/After_departure/sep2021LCMS/Bode - ycd2531-H1K1-1_20210921.raw', 2)
spect_ext1 = func1.extract_spect(3.72, 3.73).normalize
#spectra_plot([spect_ext1], './', 'spect1.svg')
func = MasslynxFunction.new('/mnt/g/Dropbox/LAb/After_departure/sep2021LCMS/Bode - ycd2531-tmx3-1_20210922.raw', 2)
...
pdct.update_info
puts pdct.inspect
chrom_plot([pdct.transpose], ['Picked'], '.', 'picked')